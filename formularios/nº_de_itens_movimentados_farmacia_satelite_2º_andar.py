...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Satélite 2º Andar)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pelo Farmácia Satélite 2º Andar**, associando cada movimentação ao centro de custo solicitante
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da Farmácia Satélite 2º Andar** entre os centros que demandaram os itens
        ...
        **Instruções específicas:**
        ...
        - Não considerar a quantidade de unidades, apenas as movimentações
        ...
        **Exemplo de cálculo:**
        ...
        O total de movimentações será utilizado para calcular o **rateio proporcional dos custos operacionais da Farmácia Satélite 2º Andar** entre os centros de custo atendidos.
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmacia Satelite 2º Andar"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmacia Satelite 2º Andar"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Farmacia Satelite 2º Andar", total_quantidade)
