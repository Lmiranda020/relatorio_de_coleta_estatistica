...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    # Nº de Itens Movimentados - Farmácia Satélite UTI
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Satélite UTI)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pela Farmácia Satélite da UTI** em cada centro de custo
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmácia Satélite UTI"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmácia Satélite UTI"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Farmácia Satélite UTI", total_quantidade)
