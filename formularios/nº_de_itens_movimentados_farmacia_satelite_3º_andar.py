...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Satélite 3º Andar)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pela Farmácia Satélite do 3º andar** em cada centro de custo
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmácia Satélite 3º andar"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmácia Satélite 3º andar"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Farmácia Satélite 3º andar", total_quantidade)
