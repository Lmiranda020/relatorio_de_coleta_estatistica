...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Exames de Análises Clínicas (CEJAM)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de exames de análises clínicas realizados pelo CEJAM**, associando cada exame ao centro de custo solicitante.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do CEJAM** entre os centros que se beneficiaram dos exames.
        3. **Unidade de medida**: Número de exames realizados.
        
        **Instruções específicas:**
        - Cada exame realizado corresponde a **uma unidade de registro**.
        - Associe cada exame ao **centro de custo que solicitou o exame**.
        - Deixe em branco ou zero se não houver exames para determinado centro de custo.
        
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Paciente A (Clínica Médica) → 1 exame de **Hemograma Completo**
            - Paciente B (Pediatria) → 1 exame de **Glicemia**
        - Dia 10/06/2022:
            - Paciente C (Clínica Médica) → 1 exame de **Urina Tipo I**
        - Total do mês:
            - Clínica Médica: 2 exames
            - Pediatria: 1 exame
        
        ✅ **Conclusão do exemplo**:
        O total de exames realizados será utilizado para calcular o **rateio proporcional dos custos operacionais do CEJAM** entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas os exames efetivamente realizados no período de referência e associe corretamente ao centro de custo solicitante.
        """)
    ...
    try:
        ...
        nome_formulario = "N° de Exames de Análises Clínicas - CEJAM"
        ...
        ponderacao = "N° de Exames de Análises Clínicas - CEJAM"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de N° de Exames de Análises Clínicas - CEJAM", total_quantidade)
