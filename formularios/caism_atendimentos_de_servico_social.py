...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - CAISM - Atendimentos de Serviço Social", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de atendimentos realizados pelo Serviço Social no CAISM**, associando cada atendimento ao centro de custo do paciente
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do Serviço Social** entre os centros que utilizaram o serviço
        3. **Unidade de medida**: Número de atendimentos (cada paciente atendido = 1 ocorrência)
        
        **Instruções específicas:**
        - Cada atendimento do Serviço Social deve ser contabilizado como **1 atendimento**
        ...
        **Exemplo de cálculo:**
        - Dia 05/06/2022:
            - Pacientes da Clínica Obstétrica → 6 atendimentos
            - Pacientes do Pronto Socorro → 3 atendimentos
        - Dia 06/06/2022:
            - Pacientes da UTI → 2 atendimentos
        - Total do mês:
            - Clínica Obstétrica: 6 atendimentos
            - Pronto Socorro: 3 atendimentos
            - UTI: 2 atendimentos
        
        Conclusão do exemplo:
        Os números registrados permitirão calcular o **rateio proporcional dos custos do Serviço Social** entre os centros de custo atendidos.
    ...
    try:
        ...
        nome_formulario = "CAISM - Atendimentos de Serviço Social"
        ...
        ponderacao = "CAISM - Atendimentos de Serviço Social"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de CAISM - Atendimentos de Serviço Social", total_quantidade)
