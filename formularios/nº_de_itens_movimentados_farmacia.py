...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Central)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pela Farmácia Central** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais da Farmácia Central** entre os centros que se beneficiaram do serviço de dispensa
        ...
        **Exemplo de cálculo:**
        ...
        No período analisado, o total de movimentações será utilizado para calcular o **rateio proporcional dos custos operacionais da Farmácia Central** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmácia"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmácia"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de de Itens Movimentados", total_quantidade)
