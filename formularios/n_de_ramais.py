...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Ramais", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de ramais de telefone** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de telefonia** entre os setores
        3. **Unidade de medida**: Número de ramais
        
        **Instruções específicas:**
        - Inclua todos os ramais de uso do centro de custo, independentemente de serem fixos ou internos
        - Associe cada ramal ao centro de custo que utiliza o serviço
        - Deixe em branco ou zero se não houver ramais no centro de custo
        
        **Exemplos:**
        - UTI Adulto: 5 ramais
        - Centro Cirúrgico: 3 ramais
        - Ambulatório: 4 ramais
        
        Conclusão do exemplo:
        No período analisado, o total de ramais será utilizado para calcular o **rateio proporcional dos custos de telefonia** entre os diferentes centros de custo.
        
        ⚠️ **Importante**: Certifique-se de registrar apenas ramais efetivamente ativos no período de referência.
        """)
    ...
    try:
        ...
        if not df_resultado.empty:
            ...
            total_ramais = df_resultado['Quantidade'].sum()
            ...
            with col3:
                st.metric("Total de Ramais", total_ramais)
