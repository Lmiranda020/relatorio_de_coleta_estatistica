...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimentos Ouvidoria/SAU/SAC", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de atendimentos realizados pela Ouvidoria, SAU ou SAC** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais desses setores de apoio** entre os centros que se beneficiaram dos atendimentos
        3. **Unidade de medida**: Número de atendimentos
        
        **Instruções específicas:**
        - Inclua apenas atendimentos efetivamente realizados no período de referência
        - Associe cada valor ao centro de custo que recebeu o atendimento
        - Deixe em branco ou zero se não houver atendimentos para o centro de custo
        
        **Exemplos:**
        - UTI Adulto: 50 atendimentos
        - Enfermaria Pediátrica: 30 atendimentos
        - Ambulatório: 20 atendimentos
        
        Conclusão do exemplo:
        No período analisado, o total de atendimentos será utilizado para calcular o **rateio proporcional dos custos operacionais da Ouvidoria/SAU/SAC** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Nº de Atendimentos Ouvidoria/SAU/SAC"
        ...
        ponderacao = "Nº de Atendimentos Ouvidoria/SAU/SAC"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Atendimentos Ouvidoria/SAU/SAC", total_quantidade)
