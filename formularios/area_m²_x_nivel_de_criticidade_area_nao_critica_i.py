...
def render_form(competencia): #crio uma função, que rece um argumento como nomeado com o parametro "competencia"
    ...
    with st.expander("📋 Instruções - Área Não Crítica - I", expanded=False):
        st.markdown("""
    ...
    try:
        ...
        nome_formulario = "Área (m²) x Nível de Criticidade (Área Não Crítica - I)"
        ...
        # verifico se exite na coluna de código cc o mesmo codigo que estou interando na linha
                    ...
                    (dados_area_metro['Criticidade_Selecionada'] == "Área Não Crítica - I")
