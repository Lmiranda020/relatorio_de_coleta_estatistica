...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimentos Serviço Social", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de atendimentos realizados pelo Serviço Social** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais do Serviço Social** entre os centros que se beneficiaram dos atendimentos
        ...
        **Exemplos:**
        - UTI Adulto: 40 atendimentos
        - Enfermaria Pediátrica: 25 atendimentos
        - Ambulatório: 15 atendimentos
        
        Conclusão do exemplo:
        No período analisado, o total de atendimentos será utilizado para calcular o **rateio proporcional dos custos operacionais do Serviço Social** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Nº de Atendimentos Serviço Social"
        ...
        ponderacao = "Nº de Atendimentos Serviço Social"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Atendimentos Serviço Social", total_quantidade)
