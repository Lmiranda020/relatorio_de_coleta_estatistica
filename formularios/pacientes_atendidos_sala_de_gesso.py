...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Pacientes Atendidos Sala de Gesso", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de pacientes atendidos na Sala de Gesso**, associando cada atendimento ao centro de custo do paciente
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da Sala de Gesso** entre os centros que utilizaram o serviço
        3. **Unidade de medida**: Número de atendimentos (cada paciente atendido = 1 ocorrência)
        
        **Instruções específicas:**
        - Cada procedimento realizado na Sala de Gesso deve ser contabilizado como **1 atendimento**
        ...
        **Exemplo de cálculo:**
        - Dia 05/06/2022:
            - Pacientes da Clínica Ortopédica → 4 atendimentos
            - Pacientes do Pronto-Socorro → 2 atendimentos
        - Dia 06/06/2022:
            - Pacientes da UTI → 1 atendimento
        - Total do mês:
            - Clínica Ortopédica: 4 atendimentos
            - Pronto-Socorro: 2 atendimentos
            - UTI: 1 atendimento
        
        Conclusão do exemplo:
        Os números registrados permitirão calcular o **rateio proporcional dos custos da Sala de Gesso** entre os centros de custo atendidos.
    ...
    try:
        ...
        nome_formulario = "Pacientes Atendidos Sala de Gesso"
        ...
        ponderacao = "Pacientes Atendidos Sala de Gesso"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Pacientes Atendidos Sala de Gesso", total_quantidade)
