...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Satélite Pronto Socorro)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pela Farmácia Satélite do Pronto Socorro** em cada centro de custo
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmácia Satélite Pronto Socorro"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmácia Satélite Pronto Socorro"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Farmácia Satélite Pronto Socorro", total_quantidade)
