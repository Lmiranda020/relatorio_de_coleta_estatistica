...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Equipamentos Ar Condicionado", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de equipamentos de ar condicionado** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de energia elétrica e manutenção** relacionados aos aparelhos de ar condicionado
        3. **Unidade de medida**: Número de equipamentos
        
        **Instruções específicas:**
        - Inclua todos os aparelhos de ar condicionado utilizados no centro de custo
        ...
        **Exemplos:**
        - UTI Adulto: 4 aparelhos
        - Centro Cirúrgico: 3 aparelhos
        - Ambulatório: 2 aparelhos
        
        Conclusão do exemplo:
        No período analisado, o total de equipamentos será utilizado para calcular o **rateio proporcional dos custos de energia elétrica e manutenção** entre os diferentes centros de custo.
        
        ⚠️ **Importante**: Registre apenas os equipamentos efetivamente instalados e utilizados no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Equipamentos Ar Condicionado"
        ...
        ponderacao = "Nº de Equipamentos Ar Condicionado"
