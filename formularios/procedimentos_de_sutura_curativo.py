...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Procedimentos de Sutura/Curativo", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de procedimentos de sutura ou curativos realizados**, associando cada procedimento ao centro de custo do paciente atendido.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do serviço de enfermagem** entre os centros que se beneficiaram dos atendimentos.
        3. **Unidade de medida**: Número de procedimentos realizados.
        
        **Instruções específicas:**
        - Cada procedimento realizado corresponde a **uma unidade de registro**.
        - Associe cada procedimento ao **centro de custo do paciente**.
        - Deixe em branco ou zero se não houver procedimentos para determinado centro de custo.
        
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Paciente A (Clínica Médica) → 1 sutura
            - Paciente B (Pediatria) → 1 curativo
        - Dia 10/06/2022:
            - Paciente C (Clínica Cirúrgica) → 1 curativo
        - Total do mês:
            - Clínica Médica: 1 procedimento
            - Pediatria: 1 procedimento
            - Clínica Cirúrgica: 1 procedimento
        
        ✅ **Conclusão do exemplo**:
        O total de procedimentos será utilizado para calcular o **rateio proporcional dos custos operacionais do serviço de enfermagem** entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas os procedimentos efetivamente realizados no período de referência e associe corretamente ao centro de custo do paciente.
        """)
    ...
    try:
        ...
        nome_formulario = "Procedimentos de Sutura/Curativo"
        ...
        ponderacao = "Procedimentos de Sutura/Curativo"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Procedimentos de Sutura/Curativo", total_quantidade)
