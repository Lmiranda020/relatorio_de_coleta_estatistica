...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - N° de Atendimentos Recepção", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de atendimentos realizados pela recepção** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais da recepção** entre os centros que se beneficiaram dos atendimentos
        ...
        **Exemplos:**
        - UTI Adulto: 150 atendimentos
        - Enfermaria Pediátrica: 100 atendimentos
        - Centro Cirúrgico: 75 atendimentos
        
        Conclusão do exemplo:
        No período analisado, o total de atendimentos será utilizado para calcular o **rateio proporcional dos custos operacionais da recepção** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "N° de Atendimentos Recepção"
        ...
        ponderacao = "N° de Atendimentos Recepção"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de N° de Atendimentos Recepção", total_quantidade)
