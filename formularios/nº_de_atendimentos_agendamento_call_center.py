...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimentos - Agendamento/Call Center", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de atendimentos realizados pelo setor de Agendamento ou Call Center** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de pessoal e recursos do setor de agendamento** entre os centros que receberam atendimento
        3. **Unidade de medida**: Número de atendimentos
        
        **Instruções específicas:**
        - Inclua apenas atendimentos efetivamente realizados pelo setor de agendamento/call center
        ...
        **Exemplos:**
        - UTI Adulto: 100 atendimentos agendados
        - Ambulatório: 200 atendimentos agendados
        - Centro Cirúrgico: 50 atendimentos agendados
        
        Conclusão do exemplo:
        No período analisado, o total de atendimentos será utilizado para calcular o **rateio proporcional dos custos de pessoal e recursos** do setor de agendamento entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas atendimentos efetivamente realizados no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Atendimentos - Agendamento/Call Center"
        ...
        ponderacao = "Nº de Atendimentos - Agendamento/Call Center"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Atendimentos - Agendamento/Call Center", total_quantidade)
