...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Horas de Utilização Sala de Estimulação Infantil", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de horas de utilização da Sala de Estimulação Infantil**, associando cada hora ao centro de custo ou serviço que utilizou a sala.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da sala e da equipe de apoio** entre os centros que se beneficiaram do serviço.
        ...
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Clínica Pediátrica: 2 horas
            - Enfermaria Pediátrica: 1 hora
        - Dia 10/06/2022:
            - Clínica Pediátrica: 1 hora
        - Total do mês:
            - Clínica Pediátrica: 3 horas
            - Enfermaria Pediátrica: 1 hora
        
        **Conclusão do exemplo:**
        O total de horas será utilizado para calcular o **rateio proporcional dos custos operacionais da Sala de Estimulação Infantil** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Horas de Utilização Sala de Estimulação Infantil"
        ...
        ponderacao = "Horas de Utilização Sala de Estimulação Infantil"
