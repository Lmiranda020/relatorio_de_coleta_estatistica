...
def render_form(competencia):
    ...
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Almoxarifado)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pelo Almoxarifado** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais do Almoxarifado** entre os centros que demandaram materiais
        ...
        **Instruções específicas:**
        ...
        - Considere requisições de materiais de consumo, descartáveis, EPI, material de escritório etc.
        ...
        **Exemplo de cálculo:**
        - Dia 05/06/2022: 1 pedido de luvas (200 unidades) e 1 pedido de máscaras (100 unidades) → **2 movimentações**
        - Dia 12/06/2022: 1 pedido de aventais (50 unidades) → **1 movimentação**
        - Total do mês: 3 movimentações, **independente da quantidade de unidades solicitadas**
        
        Conclusão do exemplo:
        O total de movimentações será utilizado para calcular o **rateio proporcional dos custos do Almoxarifado** entre os diferentes centros de custo atendidos.
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Almoxarifado"
        ...
        ponderacao = "Nº de Itens Movimentados - Almoxarifado"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Almoxarifado", total_quantidade)
