...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimento - Núcleo de Vigilância Epidemiológica", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de atendimentos realizados pelo Núcleo de Vigilância Epidemiológica** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de pessoal e recursos do Núcleo de Vigilância Epidemiológica** entre os setores que receberam o atendimento
        3. **Unidade de medida**: Número de atendimentos
        
        **Instruções específicas:**
        - Inclua apenas atendimentos efetivamente realizados pelo Núcleo de Vigilância Epidemiológica
        - Associe cada atendimento ao centro de custo que se beneficiou do serviço
        - Deixe em branco ou zero se não houver atendimentos para o centro de custo
        
        **Exemplos:**
        - Ambulatório: 50 atendimentos realizados pelo Núcleo
        - UTI Adulto: 10 atendimentos
        - Centro Cirúrgico: 5 atendimentos
        
        Conclusão do exemplo:
        No período analisado, o total de atendimentos será utilizado para calcular o **rateio proporcional dos custos de pessoal e recursos do Núcleo de Vigilância Epidemiológica** entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas atendimentos efetivamente realizados pelo Núcleo no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Atendimento Vigilância"
        ...
        ponderacao = "Nº de Atendimento Vigilância"
        ...
        if not df_resultado.empty:
            ...
            total_atendimento = df_resultado['Quantidade'].sum()
            ...
            with col3:
                st.metric("Total de Atendimento Vigilância", total_atendimento)
