...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Horas de Utilização de Sala de CCA (ADMINISTRAÇÃO - RPA)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de horas de utilização da Sala de CCA (ADMINISTRAÇÃO - RPA)**, associando cada hora ao centro de custo ou serviço que utilizou a sala.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da sala e da equipe administrativa** entre os centros que se beneficiaram do serviço.
        ...
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Centro de Custos A: 2 horas
            - Centro de Custos B: 1 hora
        - Dia 10/06/2022:
            - Centro de Custos A: 1 hora
        - Total do mês:
            - Centro de Custos A: 3 horas
            - Centro de Custos B: 1 hora
        
        **Conclusão do exemplo**:
        O total de horas será utilizado para calcular o **rateio proporcional dos custos operacionais da Sala de CCA (ADMINISTRAÇÃO - RPA)** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Horas de Utilização de Sala de CCA (ADMINISTRAÇÃO - RPA)"
        ...
        ponderacao = "Horas de Utilização de Sala de CCA (ADMINISTRAÇÃO - RPA)"
