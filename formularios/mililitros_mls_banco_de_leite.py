...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Mililitros (mls) Banco de Leite", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de leite processada ou distribuída pelo Banco de Leite**, em mililitros (ml), associando cada volume ao centro de custo solicitante.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do Banco de Leite** entre os centros que se beneficiaram do serviço.
        3. **Unidade de medida**: Mililitros (ml).
        
        **Instruções específicas:**
        - Cada volume deve ser associado ao centro de custo que solicitou ou recebeu o leite.
        - Caso o volume seja entregue a mais de um centro, registre proporcionalmente para cada um.
        - Deixe em branco ou zero se não houver volumes para determinado centro de custo.
        
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - UTI Neonatal recebeu 500 ml → 500 ml registrados para UTI
            - Enfermaria Pediátrica recebeu 300 ml → 300 ml registrados para Pediatria
        - Dia 10/06/2022:
            - UTI Neonatal recebeu 200 ml → 200 ml registrados para UTI
        - Total do mês:
            - UTI Neonatal: 700 ml
            - Pediatria: 300 ml
        
        ✅ **Conclusão do exemplo**:
        O total de volume processado ou distribuído será utilizado para calcular o **rateio proporcional dos custos operacionais do Banco de Leite** entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas os volumes efetivamente processados ou distribuídos no período de referência e associe corretamente ao centro de custo solicitante.
        """)
    ...
    try:
        ...
        nome_formulario = "Mililitros (mls) Banco de Leite"
        ...
        ponderacao = "Mililitros (mls) Banco de Leite"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Mililitros (mls) Banco de Leite", total_quantidade)
