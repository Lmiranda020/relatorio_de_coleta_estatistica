...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Horas de Utilização Realidade Virtual", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de horas de utilização da Sala de Realidade Virtual**, associando cada hora ao centro de custo ou serviço que utilizou a sala.
        ...
        **Conclusão do exemplo:**
        O total de horas será utilizado para calcular o **rateio proporcional dos custos operacionais da Sala de Realidade Virtual** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Hora de Utilização Realidade Virtual"
        ...
        ponderacao = "Hora de Utilização Realidade Virtual"
