...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Grupos / Oficinas", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de grupos ou oficinas** realizadas no período para cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio de custos** relacionados a atividades em grupo
        3. **Unidade de medida**: Número de grupos ou oficinas
        
        **Instruções específicas:**
        - Inclua apenas atividades coletivas conduzidas na unidade, como oficinas educativas, terapias em grupo, grupos de apoio..
        - Associe cada atividade ao centro de custo correspondente
        - Deixe em branco ou zero se não houver atividades realizadas
        
        **Exemplos:**
        - Ambulatório: 3 oficinas de educação em saúde
        - Psicologia: 2 grupos terapêuticos
        - Nutrição: 1 oficina de orientação alimentar
        
        Conclusão do exemplo:
        No período analisado, o total de atividades em grupo somou 6, distribuídas entre os diferentes centros de custo. Esses dados serão utilizados para calcular o **rateio proporcional dos custos de pessoal e recursos** dedicados a essas atividades.
        
        ⚠️ **Importante**: Certifique-se de registrar apenas atividades efetivamente realizadas no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Grupos / Oficinas"
        ...
        ponderacao = "Nº de Grupos / Oficinas"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Grupos / Oficinas", total_quantidade)
