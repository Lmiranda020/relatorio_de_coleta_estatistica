...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Pontos de Rede", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de pontos de rede ativos em cada centro de custo** (tomadas de rede utilizadas para computadores, impressoras, equipamentos de conectividade etc.).
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos de infraestrutura de TI e manutenção da rede**.
        3. **Unidade de medida**: Quantidade de pontos de rede.
        
        **Instruções específicas:**
        - Conte apenas os pontos de rede efetivamente **utilizados** no período de referência.
        - Associe corretamente ao **centro de custo** que faz uso do ponto.
        - Deixe em branco ou zero se o centro de custo não possuir pontos de rede ativos.
        
        **Exemplo de cálculo:**
        - Centro Administrativo: 10 pontos
        - Pronto Atendimento: 15 pontos
        - Centro Cirúrgico: 5 pontos
        - Total do mês:
            - Centro Administrativo: 10 pontos
            - Pronto Atendimento: 15 pontos
            - Centro Cirúrgico: 5 pontos
        ...
        **Conclusão do exemplo:**
        O total de pontos será utilizado para calcular o **rateio proporcional dos custos de TI e manutenção da rede** entre os diferentes centros de custo beneficiados.
        
        ⚠️ **Importante**: Registre apenas os pontos de rede efetivamente ativos e associe corretamente ao centro de custo.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Pontos de Rede"
        ...
        ponderacao = "Nº de Pontos de Rede"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Pontos de Rede", total_quantidade)
