...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    # Nº de Itens Movimentados - Farmácia Satélite Anexo 1º andar
    with st.expander("📋 Instruções - Nº de Itens Movimentados (Farmácia Satélite Anexo 1º andar)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de movimentações de itens realizadas pela Farmácia Satélite do Anexo 1º andar** em cada centro de custo
    ...
    try:
        ...
        nome_formulario = "Nº de Itens Movimentados - Farmácia Satélite Anexo 1º andar"
        ...
        ponderacao = "Nº de Itens Movimentados - Farmácia Satélite Anexo 1º andar"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Itens Movimentados - Farmácia Satélite Anexo 1º andar", total_quantidade)
