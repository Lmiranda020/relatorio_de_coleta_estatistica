...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimentos na Sala de Sinais Vitais", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de atendimentos realizados na Sala de Sinais Vitais**, discriminando por centro de custo de origem dos pacientes
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da Sala de Sinais Vitais** entre os centros que utilizaram o serviço
        3. **Unidade de medida**: Quantidade de atendimentos
        
        **Instruções específicas:**
        - Cada atendimento corresponde ao registro de um paciente que utilizou a Sala de Sinais Vitais
        - É fundamental associar cada atendimento ao **centro de custo** responsável pelo paciente
        - Se o mesmo paciente utilizou a sala em dias diferentes, registre **cada atendimento separadamente**
        - Deixe em branco ou zero se não houver atendimentos vinculados ao centro de custo
        
        **Exemplo de cálculo:**
        - Dia 05/06/2022:
            - 10 atendimentos de pacientes do Pronto Socorro
            - 5 atendimentos de pacientes da UTI
            - 5 atendimentos de pacientes da Clínica Médica
        - Dia 06/06/2022:
            - 8 atendimentos do Pronto Socorro
            - 7 atendimentos da Clínica Médica
        - Total do mês:
            - Pronto Socorro: 18 atendimentos
            - UTI: 5 atendimentos
            - Clínica Médica: 12 atendimentos
        
        Conclusão do exemplo:
        Os valores registrados permitirão calcular o **rateio proporcional dos custos da Sala de Sinais Vitais** entre os centros de custo que demandaram o serviço.
        
        ⚠️ **Importante**: Registre apenas atendimentos efetivamente realizados no período e sempre associe ao centro de custo correto.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Atendimentos na Sala de Sinais Vitais"
        ...
        ponderacao = "Nº de Atendimentos na Sala de Sinais Vitais"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de Atendimentos na Sala de Sinais Vitais", total_quantidade)
