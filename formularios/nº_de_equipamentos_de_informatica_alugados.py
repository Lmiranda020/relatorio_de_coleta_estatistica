...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Equipamentos de Informática (ALUGADOS)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de equipamentos de informática alugados** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de equipamentos de TI alugados** entre os setores
        3. **Unidade de medida**: Número de equipamentos
        
        **Instruções específicas:**
        - Inclua computadores, notebooks, impressoras, scanners e demais equipamentos que são alugados de terceiros
        - Associe cada equipamento ao centro de custo que o utiliza
        - Deixe em branco ou zero se não houver equipamentos alugados para o centro de custo
        
        **Exemplos:**
        - UTI Adulto: 2 computadores alugados
        - Centro Cirúrgico: 1 impressora alugada
        - Ambulatório: 3 notebooks alugados
        
        Conclusão do exemplo:
        No período analisado, o total de equipamentos alugados será utilizado para calcular o **rateio proporcional dos custos de aluguel** entre os diferentes centros de custo.
        
        ⚠️ **Importante**: Registre apenas os equipamentos efetivamente alugados e utilizados no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Nº de Equipamentos de Informática (ALUGADOS)"
        ...
        ponderacao = "Nº de Equipamentos de Informática (ALUGADOS)"
