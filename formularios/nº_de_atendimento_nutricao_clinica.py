...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de Atendimentos Nutrição Clínica", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de atendimentos realizados pelo setor de Nutrição Clínica**, associando cada atendimento ao centro de custo do paciente
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do setor de Nutrição Clínica** entre os centros que utilizaram o serviço
        3. **Unidade de medida**: Número de atendimentos (cada paciente atendido = 1 ocorrência)
        
        **Instruções específicas:**
        - Cada consulta, avaliação ou orientação nutricional deve ser contabilizada como **1 atendimento**
        ...
        **Exemplo de cálculo:**
        - Dia 05/06/2022:
            - Pacientes da Clínica Médica → 5 atendimentos
            - Pacientes da UTI → 2 atendimentos
        - Dia 06/06/2022:
            - Pacientes do Pronto-Socorro → 3 atendimentos
        - Total do mês:
            - Clínica Médica: 5 atendimentos
            - UTI: 2 atendimentos
            - Pronto-Socorro: 3 atendimentos
        
        Conclusão do exemplo:
        Os números registrados permitirão calcular o **rateio proporcional dos custos do setor de Nutrição Clínica** entre os centros de custo atendidos.
    ...
    try:
        ...
        nome_formulario = "Nº de atendimento Nutrição Clínica"
        ...
        ponderacao = "Nº de atendimento Nutrição Clínica"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Nº de atendimento Nutrição Clínica", total_quantidade)
