...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Nº de O.S. da Manutenção", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de Ordens de Serviço (O.S.) realizadas pelo setor de manutenção** em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos operacionais da manutenção** entre os centros que se beneficiaram dos serviços
        3. **Unidade de medida**: Número de Ordens de Serviço (O.S.)
        
        **Instruções específicas:**
        - Inclua apenas O.S. efetivamente realizadas no período de referência
        - Associe cada O.S. ao centro de custo que se beneficiou do serviço de manutenção
        - Deixe em branco ou zero se não houver O.S. para o centro de custo
        
        **Exemplos:**
        - UTI Adulto: 15 O.S.
        - Enfermaria Pediátrica: 10 O.S.
        - Centro Cirúrgico: 5 O.S.
        
        Conclusão do exemplo:
        No período analisado, o total de Ordens de Serviço será utilizado para calcular o **rateio proporcional dos custos operacionais da manutenção** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Nº de O.S. da Manutenção"
        ...
        ponderacao = "Nº de O.S. da Manutenção"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total O.S. da Manutenção", total_OS)
