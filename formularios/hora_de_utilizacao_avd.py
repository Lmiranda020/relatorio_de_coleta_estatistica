...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Horas de Utilização AVD", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de horas de utilização da Sala de AVD (Atividades de Vida Diária)**, associando cada hora ao centro de custo ou serviço que utilizou a sala.
        ...
        **Conclusão do exemplo:**
        O total de horas será utilizado para calcular o **rateio proporcional dos custos operacionais da Sala de AVD** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Hora de Utilização AVD"
        ...
        ponderacao = "Hora de Utilização AVD"
