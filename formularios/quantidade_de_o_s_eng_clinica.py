...
def render_form(competencia):
    ...
    """
    with st.expander("📋 Instruções - Quantidade de O.S. - Eng. Clínica", expanded=False): 
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de Ordens de Serviço (O.S.)** realizadas no período para cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de serviços de Engenharia Clínica terceirizados** para cada setor
        3. **Unidade de medida**: Quantidade de O.S.
        
        **Instruções específicas:**
        - Inclua apenas serviços de manutenção ou suporte contratados externamente
        ...
        **Exemplos:**
        - UTI Adulto: 12 O.S. de manutenção de equipamentos (custo total R$ 3.000)
        - Centro Cirúrgico: 8 O.S. de manutenção de equipamentos cirúrgicos (custo total R$ 2.000)
        - Ambulatório: 5 O.S. de manutenção de equipamentos (custo total R$ 1.500)
        
        Conclusão do exemplo:
        Cada centro de custo terá seu **custo proporcional de Engenharia Clínica** registrado: UTI Adulto R$ 3.000, Centro Cirúrgico R$ 2.000 e Ambulatório R$ 1.500. Esses dados permitem calcular o rateio correto dos custos de serviços de manutenção entre os setores.
        
        ⚠️ **Importante**: Certifique-se de que os valores correspondem apenas a serviços terceirizados efetivamente realizados no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "Quantidade de O.S. - Eng. Clínica"
        ...
        ponderacao = "Quantidade de O.S. - Eng. Clínica"
        ...
        if not df_resultado.empty:
            ...
            total_os = df_resultado['Quantidade'].sum()
            ...
            with col3:
                st.metric("Total de O.S", total_os)
