...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Pacientes Atendidos (Busca Ativa)", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de pacientes atendidos pelo programa de Busca Ativa**, associando cada atendimento ao centro de custo do paciente.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais do programa de Busca Ativa** entre os centros que se beneficiaram do atendimento.
        3. **Unidade de medida**: Número de pacientes atendidos.
        
        **Instruções específicas:**
        - Cada paciente atendido corresponde a **um atendimento registrado**.
        - Associe cada paciente ao **centro de custo do serviço que irá absorver o custo do atendimento**.
        - Deixe em branco ou zero se não houver atendimentos para determinado centro de custo.
        
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Paciente A (Clínica Médica) → 1 atendimento
            - Paciente B (Pediatria) → 1 atendimento
        - Dia 10/06/2022:
            - Paciente C (Clínica Médica) → 1 atendimento
        - Total do mês:
            - Clínica Médica: 2 atendimentos
            - Pediatria: 1 atendimento
        
        **Conclusão do exemplo**:
        O total de atendimentos será utilizado para calcular o **rateio proporcional dos custos do programa de Busca Ativa** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Pacientes Atendidos - Busca Ativa"
        ...
        ponderacao = "Pacientes Atendidos - Busca Ativa"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de Pacientes Atendidos - Busca Ativa", total_quantidade)
