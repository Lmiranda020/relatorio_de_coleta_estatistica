...
def render_form(competencia):
    ...
    """
    # Caixa de instruções
    with st.expander("📋 Instruções - Horas de Utilização de Sala de Exames Endoscópicos", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe o número de horas de utilização da Sala de Exames Endoscópicos**, associando cada hora ao centro de custo do paciente ou serviço que utilizou a sala.
        2. **Objetivo**: Auxiliar no **rateio proporcional dos custos operacionais da sala e da equipe de suporte** entre os centros que se beneficiaram do serviço.
        3. **Unidade de medida**: Horas de utilização.
        
        **Instruções específicas:**
        - Cada hora (ou fração de hora) de utilização deve ser registrada.
        ...
        **Exemplo de cálculo:**
        - Dia 04/06/2022:
            - Clínica Médica: 2 horas de exame endoscópico
            - Gastroenterologia: 1 hora de exame endoscópico
        - Dia 10/06/2022:
            - Clínica Médica: 1 hora de exame endoscópico
        - Total do mês:
            - Clínica Médica: 3 horas
            - Gastroenterologia: 1 hora
        
        **Conclusão do exemplo**:
        O total de horas será utilizado para calcular o **rateio proporcional dos custos operacionais da Sala de Exames Endoscópicos** entre os diferentes centros de custo beneficiados.
    ...
    try:
        ...
        nome_formulario = "Horas de Utilização de Sala de Exames Endoscópicos"
        ...
        ponderacao = "Horas de Utilização de Sala de Exames Endoscópicos"
