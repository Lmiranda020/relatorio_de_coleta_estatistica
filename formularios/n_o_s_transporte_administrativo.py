...
def render_form(competencia):
    ...
    # Caixa de instruções
    with st.expander("📋 Instruções - N° O.S. Transporte Administrativo", expanded=False):
        st.markdown("""
        ### Como preencher este formulário:
        
        1. **Informe a quantidade de Ordens de Serviço (O.S.) de transporte administrativo** realizadas em cada centro de custo
        2. **Objetivo**: Auxiliar na **análise e rateio dos custos de transporte administrativo** entre os centros que utilizaram o serviço
        3. **Unidade de medida**: Quantidade de O.S.
        
        **Instruções específicas:**
        - Inclua apenas serviços de transporte relacionados a atividades administrativas ou de suporte da unidade
        - Associe cada O.S. ao centro de custo que se beneficiou do transporte
        - Deixe em branco ou zero se não houver O.S. para o centro de custo
        
        **Exemplos:**
        - Transporte de documentos ou materiais para a Administração: 3 O.S.
        - Transporte de insumos entre setores do ambulatório: 2 O.S.
        - Transporte de pacientes internos administrativos: 1 O.S.
        
        Conclusão do exemplo:
        No período analisado, o total de O.S. de transporte administrativo será utilizado para calcular o **rateio proporcional dos custos de transporte** entre os diferentes centros de custo que utilizaram o serviço.
        
        ⚠️ **Importante**: Registre apenas O.S. efetivamente realizadas no período de referência.
        """)
    ...
    try:
        ...
        nome_formulario = "N° O.S. Transporte Administrativo"
        ...
        ponderacao = "N° O.S. Transporte Administrativo"
        ...
        if not df_resultado.empty:
            ...
            with col3:
                st.metric("Total de O.S", total_quantidade)
